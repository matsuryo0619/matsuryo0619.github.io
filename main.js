...
if (!window._isWindowOpenOverridden) {
  ...
  window.open = function (url, windowName, windowFeatures) {
    ...
    if (
      url &&
      !url.startsWith('https://Sugosuku.github.io/') &&
      !url.startsWith('#') &&
      !url.startsWith('javascript:') &&
      !url.startsWith('mailto:') &&
      !url.startsWith('tel:')
    ) {
      url = `https://Sugosuku.github.io/link?link=${encodeURIComponent(url)}`;
    }
...
const Link_observer = new MutationObserver(() => {
  document.querySelectorAll('a').forEach((a) => {
    ...
    if (
      ...
      !a.dataset.rewritten &&
      !link.startsWith('https://Sugosuku.github.io/') &&
      !link.startsWith('#') &&
      !link.startsWith('/') &&
      ...
      a.href = `https://Sugosuku.github.io/link?link=${encodeURIComponent(link)}&type=${linktype(a)}`;
